...
export function EditArtworkModal({
  ...
  const [editingFileName, setEditingFileName] =
    useState<string>("artwork-edit.jpg");
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-start justify-center bg-black bg-opacity-50 p-3 sm:p-4 overflow-y-auto"
      role="dialog"
      aria-modal="true"
    >
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                ...
                <div className="mt-4 rounded-lg border border-purple-100 bg-white/80 p-3">
                  ...
                  <div className="mt-2 flex flex-col md:flex-row md:items-center md:justify-between gap-2 text-sm text-gray-600">
                    <p>
                      Control whether this artwork can appear in the Taster
                      ...
                      <div className="flex-1 space-y-3">
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            Private works are only visible to you and customers
                            you personally invite. Domain owners and admins can
                            always review them.
                          </p>
                        </div>
                        <label className="inline-flex items-center gap-2 text-sm text-gray-800 cursor-pointer select-none">
                          ...
                          />
                          {isPrivate
                            ? "Restrict to my invitees"
                            : "Share with my full domain"}
                        </label>
                      </div>
                    </div>
                  </div>
