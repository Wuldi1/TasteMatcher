...
export function Login() {
  ...
  const handleSellerFormSubmit = useCallback(async (e: React.FormEvent) => {
    e.preventDefault();
      ...
      <div className="bg-white rounded-xl shadow-xl p-6 sm:p-8 w-full max-w-md">
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                We don't recognize this email address. Are you looking to buy or sell art?
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-700 mb-4">
                TasteMatcher helps art buyers discover pieces that match their taste through our network of galleries.
              </p>
              <p className="text-sm text-gray-700 mb-4">
              ...
              <div className="bg-white rounded-lg p-4 border border-blue-300">
                <p className="text-sm font-medium text-gray-700 mb-2">Contact us at:</p>
                <a
        ...
        {phase === 'seller-form' && (
          <form onSubmit={handleSellerFormSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="sellerDomainName" className="block text-sm font-medium text-gray-700 mb-2">
                Gallery Name
              </label>
              <input
                id="sellerDomainName"
            ...
            <div>
              <label htmlFor="sellerMessage" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-6">
              ...
              <div className="bg-white rounded-lg p-4 border border-green-200 space-y-2">
                ...
                <ul className="text-sm text-gray-600 space-y-1 ml-4 list-disc">
                  ...
                  <li>You'll receive an email at <strong className="text-gray-900">{email}</strong> with next steps</li>
                  <li>Once approved, you'll be able to log in and start uploading your collection</li>
                </ul>
              </div>
              ...
              <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600">
                  Contact us at{' '}
                  <a href="mailto:admin@tastematcher.com" className="text-blue-600 hover:text-blue-800 font-medium">
                    admin@tastematcher.com
                  </a>
                </p>
              </div>
