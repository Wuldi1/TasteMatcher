import { IsString, IsOptional, IsArray, IsNumber, IsBoolean, IsPositive, MaxLength, MinLength } from 'class-validator';
...
export class UpdateArtworkDto {
  ...
  @ApiPropertyOptional({ description: 'Artwork signature details', maxLength: 200 })
  @IsOptional()
  @IsString()
  @MaxLength(200)
  signature?: string;
